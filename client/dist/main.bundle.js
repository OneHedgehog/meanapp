...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__blog_blogitem_blogitem_component__ = __webpack_require__("../../../../../src/app/blog/blogitem/blogitem.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__blog_blogitem_blog_item_component_blog_item_component_component__ = __webpack_require__("../../../../../src/app/blog/blogitem/blog-item-component/blog-item-component.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__blog_new_post_form_new_post_form_component__ = __webpack_require__("../../../../../src/app/blog/new-post-form/new-post-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__services_blog_service_service__ = __webpack_require__("../../../../../src/app/services/blog-service.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__blog_blogitem_comment_form_comment_form_component__ = __webpack_require__("../../../../../src/app/blog/blogitem/comment-form/comment-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__services_like_service__ = __webpack_require__("../../../../../src/app/services/like.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__profile_services_profile_service__ = __webpack_require__("../../../../../src/app/profile/services/profile.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__dashboard_services_dashboard_service__ = __webpack_require__("../../../../../src/app/dashboard/services/dashboard.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_17__blog_blogitem_blogitem_component__["a" /* BlogitemComponent */],
                __WEBPACK_IMPORTED_MODULE_18__blog_blogitem_blog_item_component_blog_item_component_component__["a" /* BlogItemComponentComponent */],
                __WEBPACK_IMPORTED_MODULE_19__blog_new_post_form_new_post_form_component__["a" /* NewPostFormComponent */],
                __WEBPACK_IMPORTED_MODULE_21__blog_blogitem_comment_form_comment_form_component__["a" /* CommentFormComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_15__services_shared_service__["a" /* SharedService */], __WEBPACK_IMPORTED_MODULE_20__services_blog_service_service__["a" /* BlogServiceService */], __WEBPACK_IMPORTED_MODULE_22__services_like_service__["a" /* LikeService */], __WEBPACK_IMPORTED_MODULE_23__profile_services_profile_service__["a" /* ProfileService */], __WEBPACK_IMPORTED_MODULE_24__dashboard_services_dashboard_service__["a" /* DashboardService */]],
...
module.exports = "<h1>Post likes by date</h1>\r\n<div id=\"likesChartdiv\" [style.width.%]=\"100\" [style.height.px]=\"500\"></div>\r\n\r\n<h1>Post dislikes by date</h1>\r\n<div id=\"dislikesChartdiv\" [style.width.%]=\"100\" [style.height.px]=\"500\"></div>\r\n\r\n\r\n\r\n"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(AmCharts, dashBoardService, authService, _flashMessagesService, router) {
    ...
    DashboardComponent.prototype.ngAfterViewInit = function () {
        ...
        this.authService.getProfile()
            ...
            if (data.success === false) {
                ...
                _this.dashBoardService.getChartData(data.user.username).subscribe(function (data) {
                    console.log(data);
                    var chartData = data.mes.likes.map(function (item) {
                        item.date = item.date.split("T")[0];
                        return item;
                    });
                    var likesChart = _this.AmCharts.makeChart("likesChartdiv", {
                        "type": "serial",
                        "theme": "light",
                        "marginRight": 40,
                        "marginLeft": 40,
                    ...
                    var dislikeChartData = data.mes.dislikes.map(function (item) {
                        item.date = item.date.split("T")[0];
                        return item;
                    });
                    var dislikesChart = _this.AmCharts.makeChart("dislikesChartdiv", {
                        "type": "serial",
                        "theme": "light",
                        "marginRight": 40,
                        "marginLeft": 40,
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__amcharts_amcharts3_angular__["b" /* AmChartsService */],
            __WEBPACK_IMPORTED_MODULE_2__services_dashboard_service__["a" /* DashboardService */],
            __WEBPACK_IMPORTED_MODULE_3__services_auth_service__["a" /* AuthService */],
...
var DashboardService = /** @class */ (function () {
    ...
    DashboardService.prototype.getChartData = function (username) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__ = __webpack_require__("../../../../angular2-flash-messages/module/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_profile_service__ = __webpack_require__("../../../../../src/app/profile/services/profile.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(authService, router, _flashMessagesService, profileService) {
        this.authService = authService;
        this.router = router;
        this._flashMessagesService = _flashMessagesService;
    ...
    ProfileComponent.prototype.onChangePhoto = function (event) {
        var _this = this;
        var formData = new FormData();
        formData.append('photo', event.target.files[0], event.target.files[0].name);
        this.profileService.postPhoto(formData).subscribe(function (data) {
            if (data.success === true) {
                _this.getProfile();
                return;
            }
            _this._flashMessagesService.show(data.mes, { cssClass: 'alert-info', timeout: 1000 });
        });
    };
    ...
    ProfileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */],
            __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"],
            __WEBPACK_IMPORTED_MODULE_4__services_profile_service__["a" /* ProfileService */]])
    ], ProfileComponent);
...
var ProfileService = /** @class */ (function () {
    ...
    ProfileService.prototype.postPhoto = function (fileData) {
